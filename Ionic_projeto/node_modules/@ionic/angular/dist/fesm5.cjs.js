 ...
 * @return {?}
 */
function (ctrlName, doc, methodName) {
    var args = [];
...
/** @type {?} */
var ensureElementInBody = (/**
 * @param {?} elementName
 * @param {?} doc
 * @return {?}
 */
function (elementName, doc) {
    /** @type {?} */
...
var IonButtons = /** @class */ (function () {
    ...
    IonButtons.decorators = [
        { type: i0.Component, args: [{ selector: 'ion-buttons', changeDetection: i0.ChangeDetectionStrategy.OnPush, template: '<ng-content></ng-content>' },] },
    ];
    /** @nocollapse */
...
var IonHeader = /** @class */ (function () {
    ...
    IonHeader.decorators = [
        { type: i0.Component, args: [{ selector: 'ion-header', changeDetection: i0.ChangeDetectionStrategy.OnPush, template: '<ng-content></ng-content>', inputs: ['mode', 'translucent'] },] },
    ];
    /** @nocollapse */
...
var IonSearchbar = /** @class */ (function () {
    ...
    IonSearchbar.decorators = [
        { type: i0.Component, args: [{ selector: 'ion-searchbar', changeDetection: i0.ChangeDetectionStrategy.OnPush, template: '<ng-content></ng-content>', inputs: ['animated', 'autocomplete', 'autocorrect', 'cancelButtonIcon', 'cancelButtonText', 'clearIcon', 'color', 'debounce', 'disabled', 'mode', 'placeholder', 'searchIcon', 'showCancelButton', 'spellcheck', 'type', 'value'] },] },
    ];
    /** @nocollapse */
...
var IonTitle = /** @class */ (function () {
    ...
    IonTitle.decorators = [
        { type: i0.Component, args: [{ selector: 'ion-title', changeDetection: i0.ChangeDetectionStrategy.OnPush, template: '<ng-content></ng-content>', inputs: ['color'] },] },
    ];
    /** @nocollapse */
...
var MenuController = /** @class */ (function () {
    ...
    /** @nocollapse */ MenuController.ngInjectableDef = i0.defineInjectable({ factory: function MenuController_Factory() { return new MenuController(i0.inject(i1.DOCUMENT)); }, token: MenuController, providedIn: "root" });
